...
NoteBook2 = [
    "1. ", 
    "2. Formtting subplots - https://stackoverflow.com/questions/6541123/improve-subplot-size-spacing-with-many-subplots#:~:text=Adjust%20the%20Spacing&text=Change%20figsize%20%3A%20a%20width%20of,redundant%20labels%20on%20each%20subplot.",
    "3. ", 
    "4. ",
]
NoteBook3 = [
